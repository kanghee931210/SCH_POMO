...
class CVRPEnv:
    ...
    def load_problems(self, batch_size, aug_factor=1):
        ...
        condition_1 = torch.abs(self.time_[:,None,:].transpose(1,2) - self.time_[:,None,:]) < 60
        ...
        self._ninf = torch.zeros(size=(self.batch_size, self.pomo_size, self.problem_size))
    ...
    def reset(self):
        ...
        # shape: (batch, pomo)
        self.accum_mat = torch.zeros(size=(self.batch_size, self.pomo_size, self.problem_size+1))
        # shape: (batch, pomo, problem+1)
    ...
    def step(self, selected):
        ...
        self.Matrix_index = gathering_index.expand(self.batch_size,self.pomo_size,self.problem_size+1)
